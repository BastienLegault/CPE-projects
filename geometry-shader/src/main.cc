...
static void display_callback()
{
  ...
  glUniform1f(get_uni_loc(program, "beta"), beta); PRINT_OPENGL_ERROR();
...
int main(int argc, char *argv[])
{
  ...
  program = read_shader("data/shader.vert","data/shader.geom", "data/shader.frag",{"position","normal","tex_coord"});
  // Création du programme "normale"
  program_normal = read_shader("data/normal.vert", "data/normal.geom", "data/normal.frag",
